...
class DataObject(models.Model):
    ...
    dependencies = models.JSONField(validators=[validate_dependencies])
...
#     class Meta:
#         unique_together = ('objectName', 'tab', 'field_id')   # prevents duplicates
#         ordering = ['objectName__objectName', 'tab', 'field_id']  # keeps ordering
