...
def validate_NOT_EMPTY_CONDITION(json_spec, source_file, target_files, rule_name):
    """
    ...
    for idx, row in source_df.iterrows():
        ...
        if all(is_valid) and (pd.isna(source_value) or source_value == ""):
...
# rule_name = "material_basic_data-EXTWG should not be empty if material_basic_data- MTART=[ZSEM] AND LOT-TRACKED=[X]"

# errors = validate_NOT_EMPTY_CONDITION(json_spec, source_file, target_files,rule_name)
