...
def validate_ALLOWED_TYPE_CONDITION(json_spec, source_file, target_files, rule_name):
    errors = []
    error_set = set()
...
# rule_name = "routing-MATNR should have valid type material_basic_data- MTART=[FIN,ZSEM]"

# errors = validate_ALLOWED_TYPE_CONDITION(json_spec, source_file, target_files,rule_name)
